...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO c(33) Delete mWeatherTextView
    //-- private TextView mWeatherTextView;

    // TODO c(34) Add a private RecyclerView variable called mRecyclerView
    // TODO c(35) Add a private ForecastAdapter variable called mForecastAdapter
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                showWeatherDataView();
                // TODO c(45) Instead of iterating through every string, use mForecastAdapter.setWeatherData and pass in the weather data
                /*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            // TODO c(46) Instead of setting the text to "", set the adapter to null before refreshing
